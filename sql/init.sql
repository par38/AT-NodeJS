...
CREATE TABLE `type_of_project` (
  ...
  `projects_id` int(11) NOT NULL,
  PRIMARY KEY (`id`,`projects_id`),
  KEY `fk_type_of_project_projects1_idx` (`projects_id`),
  CONSTRAINT `fk_type_of_project_projects1` FOREIGN KEY (`projects_id`) REFERENCES `projects` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
LOCK TABLES `type_of_project` WRITE;
/*!40000 ALTER TABLE `type_of_project` DISABLE KEYS */;
/*!40000 ALTER TABLE `type_of_project` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2019-05-01 11:15:04